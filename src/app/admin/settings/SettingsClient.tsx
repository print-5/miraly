...
const INPUT_CLASS =
  "w-full rounded-xl border border-gray-200 bg-gray-50/80 text-gray-900 py-3 px-4 outline-none focus:border-red-500 focus:ring-2 focus:ring-red-500/20 transition-shadow placeholder:text-gray-400 text-sm focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation";
    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="bg-white p-5 sm:p-10 rounded-[1.5rem] sm:rounded-[3rem] shadow-sm border border-gray-100 flex flex-col sm:flex-row justify-between sm:items-center gap-4 sm:gap-6">
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="w-full sm:w-auto bg-primary text-white px-8 py-3.5 sm:py-4 rounded-xl sm:rounded-2xl font-black uppercase tracking-widest text-[10px] sm:text-xs flex items-center justify-center gap-3 shadow-lg hover:bg-gray-900 transition-all disabled:opacity-50 active:scale-[0.98] outline-none focus:ring-4 focus:ring-primary/10 touch-manipulation"
        >
          {saving ? (
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-3">
                    {settings.logo ? (
                      ...
                      <label className="w-full max-w-md h-32 border-2 border-dashed border-gray-200 hover:border-red-500 rounded-xl flex flex-col items-center justify-center cursor-pointer bg-gray-50/50 hover:bg-white transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-3">
                    {settings.favicon ? (
                      ...
                      <label className="w-24 h-24 border-2 border-dashed border-gray-200 hover:border-red-500 rounded-xl flex flex-col items-center justify-center cursor-pointer bg-gray-50/50 hover:bg-white transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation">
