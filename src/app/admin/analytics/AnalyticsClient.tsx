  ...
  return (
    <div className="space-y-10">
      <div className="bg-white p-5 sm:p-10 rounded-[1.5rem] sm:rounded-[3rem] shadow-sm border border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-6">
        <div>
          <h1 className="text-xl sm:text-3xl font-serif font-black text-gray-900 text-balance leading-tight">
        ...
        <div className="flex flex-wrap items-center gap-3 sm:gap-4 w-full sm:w-auto">
          <button
            ...
            className="flex-grow sm:flex-grow-0 bg-white px-4 sm:px-6 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-bold shadow-sm border border-gray-100 flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors text-gray-900 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation text-[10px] sm:text-xs"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10">
        ...
        <div className="bg-white p-5 sm:p-10 rounded-[1.5rem] sm:rounded-[3rem] shadow-sm border border-gray-100">
          <div className="flex justify-between items-center mb-6 sm:mb-10">
            <h3 className="text-sm sm:text-xl font-serif font-black text-gray-900 flex items-center gap-2 text-balance">
              <PieChart
                size={18}
                className="text-primary sm:w-[20px] sm:h-[20px]"
              />{" "}
              ...
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <YAxis
                    ...
                    type="category"
                    width={100}
                    tick={{ fontSize: 10, fontWeight: 700, fill: "gray-900" }}
                    axisLine={false}
                    tickLine={false}
                  />
                  <RechartsTooltip
              ...
              {data.topProducts.map((prod: any, i: number) => (
                ...
                >
                  ...
                  <div className="text-right shrink-0">
                    <p className="text-xs sm:text-sm font-black text-gray-900 tabular-nums">
        ...
        {/* Payment Methods */}
        <div className="bg-white p-5 sm:p-10 rounded-[1.5rem] sm:rounded-[3rem] shadow-sm border border-gray-100">
          <h3 className="text-sm sm:text-xl font-serif font-black text-gray-900 mb-6 sm:mb-10 flex items-center gap-2 text-balance">
            <CreditCard
              size={18}
              className="text-primary sm:w-[20px] sm:h-[20px]"
            />{" "}
                ...
                <ReChart>
                  ...
                  >
                    {data.paymentMethods.map((entry: any, index: number) => (
                      <Cell
                        key={`cell-${index}`}
                        fill={index === 0 ? "gray-900" : "orange-600"}
                      />
                    ))}
                  </Pie>
                  <RechartsTooltip
                ...
                >
                  <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                    <div
                      ...
                      style={{
                        backgroundColor: index === 0 ? "gray-900" : "orange-600",
                      }}
                    >
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs sm:text-sm font-black text-gray-900 tabular-nums truncate">
        ...
        {/* Recommendations */}
        <div className="bg-gray-900 p-6 sm:p-8 lg:p-10 rounded-[1.5rem] sm:rounded-[3rem] shadow-xl text-white relative overflow-hidden flex flex-col justify-center border-4 border-white/5">
