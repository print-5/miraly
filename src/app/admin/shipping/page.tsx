      ...
      <div className="mx-auto">
        ...
        <div className="bg-white p-5 sm:p-10 rounded-[1.5rem] sm:rounded-[3rem] shadow-sm border border-gray-100 flex flex-col sm:flex-row justify-between sm:items-center gap-4 sm:gap-6 mb-6 sm:mb-10">
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0">
              <h1 className="text-xl sm:text-3xl font-serif font-black text-gray-900 leading-none">
                Shipping Rules
              </h1>
        ...
        {availableLocations.length > 0 && (
          <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 p-6 sm:p-8 mb-6">
            <h2 className="text-lg sm:text-xl font-serif font-black text-gray-900 mb-6 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="flex items-end">
                <button
                  onClick={addRate}
                  disabled={saving}
                  className="w-full bg-primary hover:bg-gray-900 text-white py-3.5 rounded-xl font-bold transition-all shadow-lg active:scale-95 flex items-center justify-center gap-2 disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation text-xs uppercase tracking-widest"
                >
                  {saving ? (
                    ...
                    <>
                      <div className="flex flex-wrap items-center gap-4 sm:gap-6 w-full">
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-[13px] sm:text-lg font-black text-gray-900">
                            {rate.location}
                          </p>
                        </div>
                        <div className="min-w-0 flex-1">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          disabled={saving}
                          className="text-red-600 hover:text-red-700 hover:bg-red-50 p-2.5 sm:p-3 rounded-xl transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-red-500 focus-visible:outline-none touch-manipulation"
                        >
                          <Save size={18} />
                        </button>
                        <button
                    ...
                    <>
                      <div className="flex flex-wrap items-center gap-4 sm:gap-6 w-full sm:w-auto">
                        <div className="min-w-0">
                          ...
                          <p className="text-[13px] sm:text-lg font-black text-gray-900 truncate flex items-center gap-2">
                      ...
                      <div className="flex gap-2 self-end sm:self-auto">
                        <button
                          ...
                          className="text-primary hover:text-gray-900 hover:bg-primary/5 p-2.5 sm:p-3 rounded-xl transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary focus-visible:outline-none touch-manipulation"
                        >
                          <Edit2 size={18} />
                        </button>
                        <button
