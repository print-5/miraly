...
export default function FindPlaceIdPage() {
  ...
  const [businessName, setBusinessName] = useState("Miraly Foods Madurai");
                    ...
                    <div className="mb-4">
                      ...
                      {place.rating && (
                        <p className="text-sm text-gray-600 mt-1">
                          Rating: {place.rating} â­ ({place.user_ratings_total} reviews)
                        </p>
                      )}
                    </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mt-6">
                  ...
                  <ol className="space-y-2 text-sm text-blue-800">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>Go to /admin/settings â†’ Google Reviews tab</span>
                    </li>
                    <li className="flex items-start gap-2">
