...
export default function CheckoutClient({
  ...
  const calculateShipping = () => {
    ...
    // If no state is selected, return null
    return null;
  };
                ...
                >
                  ...
                  <div className="flex-grow">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1.5 bg-white border border-gray-200 text-gray-700 text-xs font-medium rounded-lg">
                        Cards
                      </span>
                      <span className="px-3 py-1.5 bg-white border border-gray-200 text-gray-700 text-xs font-medium rounded-lg">
                        UPI
            ...
            >
              <div className="flex items-center gap-3 p-4 bg-gradient-to-br from-red-50 to-red-100 rounded-xl border border-red-200">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-700">100% Secure</p>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  ...
                  {shippingPrice === null && address.state && (
                    <div className="bg-red-50 border border-red-200 rounded-lg p-3 text-xs text-red-700">
                      <p className="font-semibold mb-1">âš ï¸ Delivery Not Available</p>
                  ...
                  {discountAmount > 0 && (
                    <motion.div
                      ...
                      className="flex justify-between text-sm p-3 bg-gradient-to-r from-red-50 to-emerald-50 rounded-xl border border-red-200"
                    >
