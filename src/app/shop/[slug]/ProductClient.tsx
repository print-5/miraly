          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                {!isOutOfStock && (
                  <span className="bg-red-50 text-red-600 text-[10px] font-bold px-4 py-2 rounded-full uppercase tracking-wide inline-flex items-center gap-1.5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 pt-8 border-t border-gray-200">
                <div className="flex items-start gap-3">
                  <div className="bg-red-50 p-2 rounded-lg flex-shrink-0">
                    <Leaf size={18} className="text-red-600" />
                  </div>
                  <div>
