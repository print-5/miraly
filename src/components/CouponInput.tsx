    ...
    <form onSubmit={handleApply} className="space-y-3">
      <div className="flex gap-2">
        ...
        <button
          ...
          className="px-4 py-2 bg-[#991b1b] text-white rounded-lg font-medium text-sm hover:bg-[#991b1b] disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-2"
        >
      ...
      {success && (
        <div className="flex items-start gap-2 bg-red-50 border border-red-200 rounded-lg p-3">
          ...
          <p className="text-sm text-red-700">{success}</p>
        </div>
      )}
    </form>
  );
