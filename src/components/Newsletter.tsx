  ...
  return (
    <section className="py-24 bg-[#ece0cc]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative bg-[#991b1b] rounded-3xl px-8 py-16 md:p-20 shadow-2xl overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-xl mx-auto">
            ...
            {!subscribed ? (
              ...
              >
                ...
                <button
                  type="submit"
                  className="bg-[#f8bf51] text-[#991b1b] px-8 py-4 rounded-xl font-bold uppercase tracking-wider text-[11px] hover:bg-[#d4b76e] transition-all shadow-xl shadow-[#f8bf51]/15 flex items-center justify-center gap-2.5 active:scale-95 group shrink-0"
                >
                  Subscribe{" "}
                  <Send
                    size={14}
              ...
              >
                âœ¨ Welcome aboard! Check your inbox for 10% off your first
                order.
              </motion.div>
            )}
