      ...
      <div className="bg-white p-4 sm:p-6 md:p-8 rounded-[2rem] sm:rounded-[32px] shadow-sm border border-gray-100">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-serif font-black text-gray-900 text-balance leading-tight">
              Orders Dashboard
            </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-gradient-to-br from-primary/5 to-primary/10 p-4 sm:p-6 rounded-2xl border border-primary/10">
            ...
            <p className="text-2xl sm:text-3xl font-serif font-black text-gray-900 tabular-nums">
          ...
          <div className="bg-gradient-to-br from-red-50 to-red-100/50 p-4 sm:p-6 rounded-2xl border border-red-100">
            <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-2xl sm:text-3xl font-serif font-black text-red-600 tabular-nums">
              {stats.todayOrders}
            </p>
            <p className="text-[10px] sm:text-xs text-gray-400 mt-1 font-medium">
              New orders today
      ...
      <div className="bg-white p-3 sm:p-4 rounded-[1.5rem] sm:rounded-[24px] shadow-sm border border-gray-100 flex flex-wrap items-center gap-3 sm:gap-4 sticky top-0 z-30 backdrop-blur-md bg-white/95">
        ...
        <div className="relative flex-grow min-w-[200px] sm:min-w-[250px]">
          ...
          <input
            ...
            className="w-full bg-[gray-50] border-none rounded-xl py-2.5 sm:py-3 pl-10 sm:pl-12 pr-4 text-xs sm:text-sm font-bold text-gray-900 focus-visible:ring-2 focus-visible:ring-primary/20 transition-shadow placeholder:text-gray-400 outline-none"
            value={searchTerm}
        ...
        {/* Status Filter */}
        <div className="flex items-center gap-1 bg-[gray-50] p-1 rounded-lg sm:rounded-xl overflow-x-auto no-scrollbar max-w-full">
        ...
        <div className="flex gap-2 bg-[gray-50] p-1 rounded-lg sm:rounded-xl w-full sm:w-auto">
          <div className="relative flex-1 sm:flex-none">
            <select
              value={paymentFilter}
              onChange={(e) => setPaymentFilter(e.target.value)}
              className="appearance-none w-full bg-white border-none rounded-md sm:rounded-lg py-1.5 sm:py-2 pl-2 sm:pl-3 pr-6 sm:pr-8 text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-gray-900 outline-none cursor-pointer hover:bg-gray-50 transition-colors shadow-sm"
            >
                    ...
                    <td className="px-6 py-5">
                      <div className="relative max-w-[140px]">
                        <select
                          ...
                          className={`appearance-none w-full bg-[gray-50] border-none rounded-xl py-2.5 pl-3 pr-8 text-[10px] font-black uppercase tracking-widest cursor-pointer hover:bg-white transition-colors focus-visible:ring-2 focus-visible:ring-primary/20 touch-manipulation ${
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="relative flex-grow">
                  <select
                    ...
                    className={`appearance-none w-full bg-[gray-50] border-none rounded-xl py-2.5 pl-3 pr-8 text-[10px] font-black uppercase tracking-widest focus-visible:ring-2 focus-visible:ring-primary/20 transition-all ${
                      order.status === "Delivered"
                        ? "text-red-600"
                        : order.status === "Shipping"
                          ? "text-orange-600"
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => setViewingOrder(order)}
                    className="p-3 bg-white border border-gray-100 rounded-xl text-primary hover:bg-[gray-50] transition-all shadow-sm"
                  >
                    <Eye size={18} />
                  </button>
                  <Link
        ...
        {viewingOrder && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 bottom-0 w-full max-w-2xl bg-[gray-50] shadow-2xl z-[101] overflow-y-auto"
            >
              <div className="p-4 sm:p-8">
                ...
                <div className="flex justify-between items-start mb-6 sm:mb-8">
                  <div className="flex-grow pr-4">
                    ...
                    <h2 className="text-2xl sm:text-4xl font-serif font-black text-gray-900 text-balance leading-tight">
                  ...
                  <div className="bg-white p-4 sm:p-6 rounded-2xl border border-gray-100 relative">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className={`appearance-none w-full bg-[gray-50] border-none rounded-xl py-3 pl-4 pr-10 text-xl font-black uppercase tracking-widest cursor-pointer hover:bg-white transition-all focus-visible:ring-2 focus-visible:ring-primary/20 ${
                ...
                <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden mb-6 sm:mb-8">
                  ...
                  {/* Price Breakdown */}
                  <div className="p-4 sm:p-6 bg-[gray-50] space-y-2 sm:space-y-3">
                    ...
                    <div className="flex justify-between text-lg sm:text-2xl font-black text-gray-900 pt-3 sm:pt-4 border-t-2 border-gray-200">
                      <span>Total</span>
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  <Link
                    ...
                    target="_blank"
                    className="flex-1 bg-primary text-white py-3 sm:py-4 rounded-xl sm:rounded-2xl font-black uppercase tracking-widest text-[9px] sm:text-[10px] flex items-center justify-center gap-2 sm:gap-3 shadow-xl hover:bg-gray-900 transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation"
                  >
                  ...
                  <Link
                    ...
                    target="_blank"
                    className="flex-1 bg-red-600 text-white py-3 sm:py-4 rounded-xl sm:rounded-2xl font-black uppercase tracking-widest text-[9px] sm:text-[10px] flex items-center justify-center gap-2 sm:gap-3 shadow-xl hover:bg-red-700 transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation"
                  >
