  ...
  return (
    <div className="space-y-10">
      <div className="bg-white p-5 sm:p-10 rounded-[1.5rem] sm:rounded-[3rem] shadow-sm border border-gray-100 flex flex-col sm:flex-row justify-between sm:items-center gap-4 sm:gap-6">
        <div>
          <h1 className="text-xl sm:text-3xl font-serif font-black text-gray-900 text-balance leading-none">
            Customer Database
          </h1>
          ...
          >
            <div className="flex items-center gap-4 sm:gap-5 mb-6 sm:mb-8">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary/5 rounded-[1rem] sm:rounded-2xl flex items-center justify-center text-primary font-black text-lg sm:text-xl relative shadow-inner border border-primary/5">
                {customer.name[0]}
                <div className="absolute -bottom-1 -right-1 w-5 h-5 sm:w-6 sm:h-6 bg-red-500 rounded-lg border-2 sm:border-4 border-white flex items-center justify-center text-white shadow-sm">
                  <UserCheck size={10} className="sm:w-3" />
                </div>
              </div>
              <div className="min-w-0">
                <h3 className="text-base sm:text-lg font-serif font-black text-gray-900 truncate">
                  {customer.name}
                </h3>
            ...
            <div className="grid grid-cols-2 gap-4 py-6 border-t border-gray-50">
              <div>
                ...
                <div className="flex items-center gap-1.5 font-black text-gray-900 tabular-nums text-xs sm:text-sm">
