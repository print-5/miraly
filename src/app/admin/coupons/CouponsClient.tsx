    ...
    <div className="space-y-8 pb-20">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-4">
            <div>
              ...
              <h1 className="text-xl sm:text-3xl lg:text-4xl font-serif font-black text-gray-900 text-balance leading-none sm:leading-tight">
                Coupon Manager
              </h1>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            <button
              ...
              className="bg-primary text-white px-8 py-3.5 sm:py-4 rounded-xl sm:rounded-2xl font-black shadow-lg shadow-primary/20 hover:bg-gray-900 transition-all flex items-center justify-center gap-2 active:scale-95 text-[10px] uppercase tracking-widest focus:ring-4 focus:ring-primary/10 touch-manipulation w-full sm:w-auto"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <div className="bg-white p-5 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] border border-gray-100 flex items-center gap-5 sm:gap-6 shadow-sm">
          ...
          <div className="min-w-0">
            ...
            <h3 className="text-2xl sm:text-3xl font-serif font-black text-gray-900 tabular-nums truncate">
              {coupons.length}
            </h3>
          </div>
        </div>
        <div className="bg-white p-5 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] border border-gray-100 flex items-center gap-5 sm:gap-6 shadow-sm">
          <div className="w-12 h-12 sm:w-16 sm:h-16 bg-red-50 rounded-xl sm:rounded-2xl flex items-center justify-center text-red-600 shrink-0 transition-transform group-hover:scale-110">
      ...
      {coupons.length === 0 ? (
        <div className="bg-white rounded-[3rem] p-20 text-center border border-gray-100 flex flex-col items-center">
          ...
          <h2 className="text-2xl font-serif font-bold text-gray-900 mb-2 text-balance">
            No Active Coupons
          </h2>
                ...
                <div className="p-6 space-y-5 flex-1 bg-white">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 font-black text-lg sm:text-2xl text-gray-900 tabular-nums truncate">
                        {coupon.discountType === "percentage" ? (
                          ...
                          <>
                            <IndianRupee
                              size={14}
                              className="text-[#ea580c] sm:w-5 sm:h-5"
                            />
                            {coupon.discountValue}
                          </>
                        ) : (
              ...
              >
                ...
                <div className="overflow-y-auto px-8 py-6 flex-1 custom-scrollbar">
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-[gray-50] border-none focus:ring-2 focus:ring-primary/20 rounded-2xl py-4 pl-12 pr-6 outline-none transition-shadow font-black text-lg uppercase tracking-wider text-gray-900 placeholder:text-gray-300"
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <select
                          ...
                          className="w-full bg-[gray-50] border-none focus:ring-2 focus:ring-primary/20 rounded-2xl py-4 px-6 outline-none transition-colors font-medium text-gray-700 appearance-none cursor-pointer"
                        >
                        ...
                        <div className="space-y-2 animate-in fade-in">
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full bg-[gray-50] border-none focus:ring-2 focus:ring-primary/20 rounded-2xl py-4 pl-12 pr-6 outline-none transition-shadow font-bold text-gray-700"
                              placeholder="20"
                            />
                          </div>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full bg-[gray-50] border-none focus:ring-2 focus:ring-primary/20 rounded-2xl py-4 px-6 outline-none transition-shadow font-bold text-gray-700"
                          placeholder="âˆž"
                        />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="flex gap-4">
                      <label className="flex items-center gap-3 bg-[gray-50] py-4 px-6 rounded-2xl cursor-pointer flex-1 border border-transparent hover:border-primary/10 transition-colors">
                        <input
                          type="checkbox"
                ...
                <div className="p-8 border-t border-gray-100 bg-gray-50 flex gap-4">
                  ...
                  <button
                    ...
                    className="flex-1 bg-primary text-white py-4 rounded-2xl font-bold hover:bg-gray-900 transition-colors shadow-xl active:scale-95 disabled:opacity-70 flex items-center justify-center gap-2 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation"
                  >
                    {isActionLoading ? (
              ...
              >
                  ...
                  >
                    <div className="grid grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full bg-[gray-50] border-none focus:ring-2 focus:ring-primary/20 rounded-2xl py-4 px-6 outline-none transition-shadow font-black uppercase text-gray-900"
                          placeholder="E.g. NEW"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        className="w-full bg-[gray-50] border-none focus:ring-2 focus:ring-primary/20 rounded-2xl py-4 px-6 outline-none transition-shadow font-medium text-gray-700 appearance-none cursor-pointer"
                      >
                        <option value="percentage">Percentage (%)</option>
                        <option value="fixed">Fixed Amount (₹)</option>
                        <option value="free-delivery">Free Delivery</option>
                ...
                <div className="p-8 border-t border-gray-100 bg-gray-50 flex gap-4">
                  ...
                  <button
                    ...
                    form="bulk-form"
                    disabled={isActionLoading}
                    className="flex-1 bg-primary text-white py-4 rounded-2xl font-bold hover:bg-gray-900 transition-colors shadow-xl active:scale-95 disabled:opacity-70 flex items-center justify-center gap-2"
                  >
                    {isActionLoading ? (
                      <Loader2 className="animate-spin" size={18} />
                    ) : (
