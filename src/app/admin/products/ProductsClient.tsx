...
export default function ProductsClient({
  ...
  return (
    <div className="space-y-8 font-sans">
        ...
        {[
          ...
          >
            <div className="min-w-0">
              ...
              <h3 className="text-sm sm:text-2xl font-serif font-black text-gray-900 tabular-nums truncate">
                {kpi.value}
              </h3>
            </div>
            <div
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-6 bg-white p-5 sm:p-10 rounded-[1.5rem] sm:rounded-[3rem] border border-gray-100 shadow-sm transition-all">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-3xl lg:text-4xl font-serif font-black text-gray-900 leading-none">
            Product <span className="text-red-600 italic">Vault</span>
          </h1>
          <p className="text-gray-500 mt-2 font-medium text-[10px] sm:text-sm truncate">
        ...
        <button
          ...
          className="w-full sm:w-auto bg-gradient-to-r from-red-600 to-orange-600 text-white px-8 py-3.5 sm:py-4 rounded-xl font-black shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2 active:scale-95 text-[10px] sm:text-xs uppercase tracking-widest"
        >
          <Plus size={18} />
      ...
      {/* Controls Bar */}
      <div className="flex flex-col md:flex-row gap-4 md:items-center justify-between sticky top-0 z-30 py-3 sm:py-5 bg-[gray-50]/90 backdrop-blur-md">
        <div className="relative flex-grow max-w-full md:max-w-md group bg-white rounded-xl border border-gray-200 shadow-sm">
          <Search
          ...
          <input
            ...
            className="w-full bg-transparent py-3 sm:py-4 pl-12 pr-4 outline-none font-bold text-gray-900 placeholder:text-gray-400 touch-manipulation text-[11px] sm:text-sm"
          />
        </div>
        <div className="flex gap-2 sm:gap-3">
          ...
          <Link
            href="/admin/uom"
            className="hidden sm:flex items-center justify-center gap-2 px-6 py-4 bg-white border border-gray-200 rounded-xl font-black text-gray-500 hover:text-gray-900 transition-all shadow-sm uppercase tracking-widest text-[10px]"
          >
          ...
          <button
            ...
            className="w-12 h-12 sm:w-14 sm:h-14 bg-white border border-gray-200 rounded-xl flex items-center justify-center text-gray-500 hover:text-gray-900 transition-all shadow-sm shrink-0"
          >
            {viewMode === "list" ? (
              <LayoutGrid size={18} />
            ) : (
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  ...
                  className="text-xs font-bold text-red-600 hover:underline uppercase tracking-wider focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation rounded"
                >
                  Clear All
                </button>
              </div>
              ...
              {(selectedCategory !== "all" ||
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedCategory !== "all" && (
                      <span className="px-3 py-1 bg-red-50 text-red-600 text-xs font-bold rounded-full flex items-center gap-2">
      ...
      <div className="space-y-4">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20">
            <div className="w-16 h-16 border-4 border-red-600 border-t-orange-600 rounded-full animate-spin mb-6" />
            ...
            {filteredProducts.map((p, i) => {
              ...
              return (
                <motion.div
                  ...
                  transition={{ delay: i * 0.05 }}
                  className="group bg-white rounded-xl p-3 sm:p-4 border border-gray-200 hover:border-red-200 hover:shadow-lg transition-all duration-300 flex flex-row items-center gap-3 sm:gap-6 relative overflow-hidden focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation"
                >
                  {/* Decoration Line */}
                  <div className="absolute left-0 top-0 bottom-0 w-1 bg-red-600 opacity-0 group-hover:opacity-100 transition-opacity" />

                  {/* Image */}
                  <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gray-50 rounded-lg overflow-hidden flex-shrink-0 relative group-hover:scale-105 transition-transform duration-500">
                    {p.images?.[0] ? (
                      <Image
                        src={p.images[0]}
                  ...
                  <div className="flex-grow flex flex-col md:flex-row md:items-center justify-between gap-4 min-w-0">
                    ...
                    <div className="flex-grow min-w-0">
                      <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 mb-1 min-w-0">
                        <h3 className="font-bold text-sm sm:text-lg text-gray-900 leading-tight truncate">
                          {p.name}
                        </h3>
                        <span className="px-2 py-0.5 bg-gray-50 text-gray-600 text-[8px] sm:text-[10px] font-black uppercase tracking-widest rounded-full w-fit border border-gray-200 shrink-0">
                          {p.category}
                        </span>
                      </div>
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-4 sm:gap-8 lg:gap-12 shrink-0 pr-1">
                      ...
                      <div className="text-left sm:text-right">
                        ...
                        <p className="text-sm sm:text-lg font-serif font-black text-gray-900 tabular-nums">
                          ₹{minPrice}
                        </p>
                      </div>
                      ...
                      <div className="flex gap-1 sm:gap-2 shrink-0">
                        <button
                          ...
                          className="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-gray-400 hover:text-gray-900 hover:bg-gray-50 transition-colors border border-transparent focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation"
                        >
                          <Edit2
                            size={14}
                        ...
                        <button
                          ...
                          className="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-gray-400 hover:text-red-600 hover:bg-red-50 transition-colors border border-transparent focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none touch-manipulation"
                        >
                          <Trash2
                            size={14}
                            className="sm:w-[18px] sm:h-[18px]"
