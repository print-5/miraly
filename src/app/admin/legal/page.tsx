  ...
  return (
    <div className="space-y-8">
      <div className="bg-white p-5 sm:p-10 rounded-[1.5rem] sm:rounded-[3rem] shadow-sm border border-gray-100 flex flex-col sm:flex-row justify-between sm:items-center gap-4 sm:gap-6">
        <div>
          <h1 className="text-xl sm:text-3xl font-serif font-black text-gray-900 leading-tight">
            Legal Pages
          </h1>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full text-lg sm:text-xl font-serif font-black text-gray-900 p-4 bg-gray-50 rounded-xl border border-transparent focus:bg-white focus:border-primary/20 outline-none transition-all placeholder:text-gray-200"
              ...
              <div className="flex justify-end pt-4 border-t border-gray-100">
                <button
                  ...
                  className="w-full sm:w-auto px-8 py-4 bg-primary text-white rounded-xl sm:rounded-2xl font-black uppercase tracking-widest text-[10px] sm:text-xs flex items-center justify-center gap-2 hover:bg-gray-900 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl active:scale-95 touch-manipulation focus:ring-4 focus:ring-primary/10"
                >
                  {saving ? (
