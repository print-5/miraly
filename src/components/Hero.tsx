...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[100vh] flex items-center overflow-hidden bg-[#991b1b]">
      {/* Background Image */}
      <div className="absolute inset-0 z-0">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#991b1b] via-[#991b1b]/85 to-[#991b1b]/40" />
        <div className="absolute inset-x-0 bottom-0 h-48 bg-gradient-to-t from-[#991b1b] to-transparent" />
      </div>
      ...
      <div className="w-full px-6 md:px-12 lg:px-24 relative z-10 pt-44 pb-20">
        <div className="max-w-3xl">
          ...
          >
            Handpicked spices, traditional recipes, and pure ingredients â€”
          ...
          >
            <Link
              href="/shop"
              className="bg-[#f8bf51] text-[#991b1b] px-10 py-5 rounded-2xl font-bold uppercase tracking-wider text-[12px] shadow-xl shadow-[#f8bf51]/20 hover:bg-[#d4b76e] transition-all active:scale-95 flex items-center gap-3 group"
            >
              Shop Now
              <ArrowRight
                size={16}
