  ...
  return (
    <div className="space-y-8">
      <header className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
        <div>
          <h1 className="text-2xl sm:text-3xl font-serif font-black text-gray-900 tracking-tighter text-balance">
            Event Enquiries
          </h1>
        ...
        <div className="p-4 sm:p-6 md:p-8 border-b border-gray-50 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
          <div className="relative flex-grow max-w-md w-full">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-gray-50 border border-transparent focus:border-primary/20 rounded-2xl text-[13px] font-bold text-gray-900 outline-none transition-all placeholder:text-gray-300 focus:bg-white touch-manipulation shadow-sm"
            />
          </div>
        </div>
              ...
              >
                <div className="flex justify-between items-start gap-4">
                  <div className="flex flex-col min-w-0">
                    <span className="font-black text-gray-900 text-sm truncate uppercase tracking-tight">
                      {enq.name}
                    </span>
                ...
                <div className="flex items-center justify-between gap-3 pt-2">
                  <div className="relative flex-grow">
                    <select
                      ...
                      className="w-full appearance-none bg-primary text-white text-[9px] font-black uppercase tracking-[0.2em] rounded-xl px-4 py-3 outline-none transition-all hover:bg-gray-900 focus:ring-4 focus:ring-primary/10 touch-manipulation"
                    >
